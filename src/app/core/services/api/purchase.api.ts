...
export class PurchaseApi {
    ...
    getPurchases(params: PurchaseQueryParams): Observable<ApiResponse<PaginatedResponse<PurchaseResource>>> {
        ...
        return this.http.get<any>(this.API_URL, { params: httpParams }).pipe(
            map(res => {
                // Defensive mapping for paginated data
    ...
    updatePurchase(id: number | string, data: CreatePurchasePayload): Observable<ApiResponse<PurchaseResource>> {

...
export class AttendanceApi {
    ...
    checkIn(data: AttendanceCheckInRequest): Observable<{ success: boolean; message: string; data: AttendanceResource }> {
        return this.http.post<{ success: boolean; message: string; data: AttendanceResource }>(`${this.apiUrl}/check-in`, data);
    }

    checkOut(id: string | number): Observable<{ success: boolean; message: string; data: AttendanceResource }> {
        return this.http.patch<{ success: boolean; message: string; data: AttendanceResource }>(`${this.apiUrl}/${id}/check-out`, {});
    }
}

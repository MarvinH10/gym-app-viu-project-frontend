...
export class MembershipPlanApi {
    ...
    updatePlan(id: string | number, data: any): Observable<{ message: string; data: MembershipPlanResource }> {
        return this.http.put<{ message: string; data: MembershipPlanResource }>(`${this.apiUrl}/${id}`, data);
    }
    ...
    toggleStatus(id: string | number): Observable<{ success: boolean; message: string; data: MembershipPlanResource }> {

...
@Component({
    ...
    styleUrl: './proveedor-create-edit.css',
...
export default class ProveedorCreateEditComponent implements OnInit {
    ...
    private loadSupplierData(id: string) {
        ...
        this.supplierApi.getSupplier(id).subscribe({
            next: (res) => {
                const data = {
                    ...res.data,
                    name: res.data.business_name || res.data.full_name,
    ...
    onFormSubmit(formData: any) {
        ...
        const request = id ? this.supplierApi.updateSupplier(id, payload) : this.supplierApi.createSupplier(payload);

    ...
    readonly detailSections = signal<DetailSection[]>([
        {
            ...
            fields: [
                ...
                { name: 'status', label: 'Estado Acceso', type: 'badge', badgeVariant: (v) => v === 'valid' ? 'secondary' : 'destructive', transform: (v) => v === 'valid' ? 'Válido' : 'Denegado' },
                { name: 'validation_message', label: 'Mensaje Validación' },
            ],
        },
        {

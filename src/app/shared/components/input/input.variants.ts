...
export const inputVariants = cva('w-full', {
  variants: {
    zType: {
      ...
      textarea:
        'flex pb-2 min-h-20 h-auto rounded-md border px-4 py-2 font-normal border-input bg-transparent placeholder:text-muted-foreground outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] disabled:cursor-not-allowed disabled:opacity-50',
    },
    zSize: {
      default: 'text-sm',
      sm: 'text-xs',
